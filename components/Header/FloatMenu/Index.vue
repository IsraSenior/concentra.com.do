    ...
    <div class="">
        ...
        <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1"
            ...
            <div v-if="dropdown" :class="[
                ...
                <div class="grid grid-cols-2 divide-x divide-primary-900/5 bg-primary-50">
                    <a v-for="(cta, index) in item.ctas" :key="index" href="#"
                        class="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-primary-900 hover:bg-primary-100">
