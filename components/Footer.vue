        ...
        <div class="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
            <div class="xl:grid xl:grid-cols-3 xl:gap-10">
                <div>
                    ...
                    <p class="mt-6 text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate ex quidem at</p>
                </div>
                <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">SOFTEXPERT</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">SOLARWIND</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">CARNBONITE</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">SHUFTI PRO</a>
                                </li>
                                <li>
                        ...
                        <div class="mt-10 md:mt-0">
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                ...
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">OBSERVE IT</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">SERVICES BOX</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">Outsourcing</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">Soporte técnico</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">Software factory</a>
                                </li>
                            </ul>
                        </div>
                        <div class="mt-10 md:mt-0">
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">Terminos y condiciones</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">Políticas de privacidad</a>
                                </li>
                                <li>
                                    <a href="#" class="text-sm/6 text-gris-aluminio hover:text-primary">Licencias</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm/6 text-gris-aluminio">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut, ratione.</p>
                </div>
            ...
            <div class="mt-8 border-t border-white/5 pt-8 md:flex md:items-center md:justify-between">
                ...
                <p class="mt-8 text-sm/6 text-gris-aluminio md:order-1 md:mt-0">&copy; 2025 ConCentra, SRL. Todos los derechos reservados.</p>
                <p class="mt-8 text-sm/6 text-gris-aluminio md:order-1 md:mt-0">Desarrollador por <a href="https://zunamicorp.com" target="_blank" rel="noopener noreferrer" class="hover:text-primary -underline-offset-8">ZunamiCorp</a></p>
            </div>
        </div>
    </footer>
</template>
